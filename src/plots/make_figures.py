# make_figures.py
"""
Generate all figures_original for Chapter 4 from:
- results/baseline_metrics_log.csv
- results/epsilon_metrics_log.csv

Outputs (saved under ./figures_original/):
...
# ---------------------------
# Figure 1: Baseline metrics (per fold + mean band)
# ---------------------------
...
# mean ± std across folds per (noise_multiplier, epoch)
...
# Also summarize by noise only (across all epochs)
...
# ---------------------------
# Figure 2: DP metrics vs noise (bar chart with error bars)
# ---------------------------
...
# ---------------------------
# Figure 3: Epsilon trade-off curves (metrics vs epsilon, one line per noise)
# ---------------------------
...
# ---------------------------
# Figure 4: Baseline vs DP (side-by-side comparison)
# ---------------------------
